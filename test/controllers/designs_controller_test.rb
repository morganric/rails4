...
class DesignsControllerTest < ActionController::TestCase
  ...
  test "should create design" do
    assert_difference('Design.count') do
      post :create, design: { description: @design.description, image: @design.image, slug: @design.slug, title: @design.title }
    end
  ...
  test "should update design" do
    patch :update, id: @design, design: { description: @design.description, image: @design.image, slug: @design.slug, title: @design.title }
    assert_redirected_to design_path(assigns(:design))
  end
